...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dwave-cloud-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15615&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dwave-cloud-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dwave-cloud-client` can be installed with:

```
conda install dwave-cloud-client
```

It is possible to list all of the versions of `dwave-cloud-client` available on your platform with:
